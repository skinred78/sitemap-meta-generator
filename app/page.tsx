    ...
    <main className="min-h-screen p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          Generate SEO-optimized Japanese meta tags for single URLs or entire sitemaps
        </p>
      </div>
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex gap-8">
          ...
          >
            Batch Mode
            <span className="ml-2 text-xs text-gray-500">(Sitemap Upload)</span>
          </button>
          <button
          ...
          >
            Quick Mode
            <span className="ml-2 text-xs text-gray-500">(Single URL)</span>
          </button>
        </nav>
      </div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 max-w-md mx-4">
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Confirm Large Processing
                </h3>
                <p className="text-gray-700 mb-4">
                  You're about to process{' '}
                  <span className="font-semibold">{totalUrlsToProcess}</span> URLs. This will take
                  approximately {Math.ceil(totalUrlsToProcess / 5)} minutes and cost around $
                    ...
                    {results.map((result, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm text-center">
                          <span
                            className={
                              result.titleCharCount >= 30 && result.titleCharCount <= 35
                          ...
                          {result.compliance ? (
                            <div className="flex flex-col items-center gap-1">
                              ...
                              {result.compliance.violations.length > 0 && (
                                ...
                                >
                                  {result.compliance.violations.length} issue
                                  {result.compliance.violations.length > 1 ? 's' : ''}
                                </button>
                              )}
                            </div>
                          ) : (
              ...
              <div className="bg-white rounded-lg p-6 max-w-2xl mx-4 max-h-[80vh] overflow-y-auto">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    ...
                    <span
                      className={
                        selectedViolations.compliance!.score >= 85
                          ? 'text-green-600'
                          : 'text-red-600'
                      }
                    >
